...
if(ZLIB_FOUND)
  ...
  if(NOT PNG_LIBRARY)
    find_library(PNG_LIBRARY_RELEASE NAMES ${PNG_NAMES} PATHS "${RDP_ROOT}/lib" )
    find_library(PNG_LIBRARY_DEBUG NAMES ${PNG_NAMES_DEBUG} PATHS "${RDP_ROOT}/lib" )
